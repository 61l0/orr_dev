...
(function ($) {
    ...
    */      
    $.fn.editableform.template = '<form id="form-inline" class="form-inline editableform">'+
    '<div class="control-group">' + 
    '<div><div class="editable-input"></div><br><textarea style="margin-top:4px;margin-bottom:2px;height:70px;width:270px" class="form-control input-large" name="deskripsi" Placeholder="DESKRIPSI/JUSTIFIKASI" id="deskripsi"></textarea><br><div style="margin-left:0px" class="editable-buttons"></div></div>'+
...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit"><i class="glyphicon glyphicon-ok glyphicon-white"></i></button>'+
