	...
	function refreshtable(){
			 ...
			 var email =$("#email").val();
			  ...
			  type: "POST",
			  data: "email="+email,
			  url: "<?php echo base_url()?>kirim_email/search",
			  beforeSend: function() {
				$("#tabledata").html("<div class='loading_div'><img src='<?php echo base_url() ?>img/loading.gif'></div>");
			  },
			  success: function(msg) {
	...
	function delete_data(id){
		...
		$( "#infodlg" ).dialog({ title:"Info...", draggable: false, modal: true, buttons: {
					 "Ya": function(){
							  $.ajax({
									url:'<?php echo base_url(); ?>kirim_email/delete/'+id,		 
									type:'POST',
									data:"",
...
<br>
  ...
  <a href="<?php echo base_url();?>kirim_email/form" class="btn btn-success btn-sm pull-right" style="margin:5px"> 
