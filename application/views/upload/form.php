...
<div id="confirm" style="display:none"> Anda Ingin Mengirm File Ini ? </div>     
...
<fieldset>
    ...
    <table style="width:100%" >
	    ...
	    <td class="btn btn-primary" style="margin:0px; text-align:left"> <b>Upload</b> 
    ...
    <hr>
    <a onclick="return confirmdlg()" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-ok"></i> Kirim </a>
    <a href="<?php echo base_url();?>upload" class="btn btn-danger  btn-sm"><i class="glyphicon glyphicon-remove"></i> Batal  </a>
</fieldset>
</form>
<br>