   ...
   <link rel="stylesheet" href="<?php echo base_url();?>css/themes/jquery.ui.all.css" type="text/css" />
	...
	function save(){
		$.ajax({
			url:'<?php echo base_url(); ?>unit_kerja/act/',		 
			type:'POST',
			...
			success:function(data){ 
			  	if(data!=''){
					 ...
					 window.location="<?php echo base_url() ?>unit_kerja";
				}
			 }
		});		
	}
  ...
  <table style="width:100%">
    ...
    <tr>
      ...
      <td><input type="text" name="id_divisi" name="id_divisi"  
       style="width:100px"  class="form-control input-sm"   value="<?php echo isset($infouser['kd_unit_kerja']) ? $infouser['kd_unit_kerja'] : ''; ?>"/>
        </td>
    </tr>
    <tr>
    <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><input class="form-control  input-sm"  type="text" name="nama"  id="nama" style="width:500px" value="<?php echo isset($infouser['nama']) ? $infouser['nama'] : ''; ?>" />
         </td>
    </tr>
     <tr>
    <td>&nbsp;</td>
    ...
    <tr>
      <td>Pusat</td>
      <td>
      <select id="pusat" name="pusat" style="width:300px" class="form-control input-sm">
