	...
	function refreshtable(){
			 ...
			 var kewenangan =$("#kewenangan").val();
			  ...
			  type: "POST",
			  data: "kewenangan="+kewenangan,
			  url: "<?php echo base_url()?>kewenangan/search",
			  beforeSend: function() {
				$("#tabledata").html("<div class='loading_div'><img src='<?php echo base_url() ?>img/loading.gif'></div>");
			  },
			  success: function(msg) {
	...
	function delete_data(id){
		...
		$( "#infodlg" ).dialog({ title:"Info...", draggable: false, modal: true, buttons: {
					 "Ya": function(){
							  $.ajax({
									url:'<?php echo base_url(); ?>kewenangan/delete_data/'+id,		 
									type:'POST',
									data:"",
...
<br>
  ...
  <a href="<?php echo base_url();?>kewenangan/form" class="btn btn-success btn-sm pull-right" style="margin:5px"> 
