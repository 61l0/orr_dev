<script>
 ...
 <script>
  ...
  function save_live_edit_indikator(){
		$.ajax({
			url:'<?php echo base_url(); ?>template_renja/save_live_edit_indikator/',		 
			type:'POST',
			data:$('#frm_indikator').serialize(),
...
<form id="frm_indikator" name="frm_indikator">
...
<input type="hidden" id="tipe_input" name="tipe_input" maxlength="5" size="5" value="<?php echo $tipe_input;?>"/>
		<table style="width:100%">
				...
				<tr>
					<td style="width:150px">Program / Parent </td>
				...
				<tr>
					...
					<td style="width:20px"><center>:</center></td>
					<td><input type="text" name="urutan" id="urutan"   class="form-control input-sm" value="<?php echo isset($infouser['urutan']) ? $infouser['urutan'] : '0'; ?>" style="width:50px;float:left"> <code style="margin-left:10px;float:left;margin-top:10px"> Tidak Akan Ditampilkan Pada Data Renja </code></td>
				</tr>
				<tr>
					<td style="width:150px">Kode </td>
					<td style="width:20px"><center>:</center></td>
					<td><input type="text" name="kode" id="kode"   class="form-control input-sm" value="<?php echo isset($infouser['kode']) ? $infouser['kode'] : '-'; ?>" style="width:150px;float:left"></td>
				</tr>
				<tr>
					<td>Indikator</td>
					<td style="width:20px"><center>:</center></td>
					<td><input type="text" style="width:96%" name="indikator" id="indikator" class="form-control input-sm" value="<?php echo isset($infouser['indikator']) ? $infouser['indikator'] : '-'; ?>"></td>
				</tr>
				<!--<tr>
					<td>Komponen Input </td>
					<td style="width:20px"><center>:</center></td>
					<td><input readonly type="text" style="width:90%" name="komponen_input" id="komponen_input" class="form-control input-sm" 
					value=""></td>
				</tr>
				<tr>
					<td>Sasaran Kegiatan</td>
					<td style="width:20px"><center>:</center></td>
					<td><input readonly type="text" name="sasaran_kegiatan" id="sasaran_kegiatan" class="form-control input-sm" value=""></td>
				</tr> -->
				<tr>
					<td >Target </td>
					<td style="width:20px"><center>:</center></td>
					<td><input type="text" name="target" id="target" class="form-control input-sm" value="<?php echo isset($infouser['target']) ? $infouser['target'] : '-'; ?>" style="width:80%"></td>
				</tr>
				</table>
				<table>
					<tr>
						...
						<td><select name="kl"  class="form-control nilai input-sm" id="kl" >	
