...
<br>
   ...
   <a href="<?php echo base_url();?>capaian/form" class="btn btn-success btn-sm pull-right" style="margin:5px"> 
   <i class="glyphicon glyphicon-plus"></i> Tambah</a>

   <a href="<?php echo base_url();?>capaian/export_excel" class="btn btn-info btn-sm pull-right" style="margin:5px"> 
   <i class="glyphicon glyphicon-export"></i> Export to Excel</a>

   <a href="<?php echo base_url();?>capaian/download_info" class="btn btn-warning btn-sm pull-right" style="margin:5px"> 
