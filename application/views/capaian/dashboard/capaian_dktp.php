                ...
                dataLabels: {
                 ...
                 events: {
                  click: function() {  
                  			...
                  			$.ajax({
								url:'<?php echo base_url(); ?>capaian/get_detail/4/'+<?php echo $id;?>,		 
								type:'POST',
 ...
 <div id="graph_capaian_dktp" style="height:350px !important;width:50% !important"></div>
